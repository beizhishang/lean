...
var obj = [
    ...
    {value: 'FTE录入', hrefLink: 'http://portal.innoventbio.com:8000/workflow/task?TaskId=S0912092013b9ce83179f0d00642905&ProcessName=FTE%E5%BD%95%E5%85%A5&ProcessVersion=4', tag: '项目管理类'},
    ...
    {value: 'M2设备使用域密码修改', hrefLink: 'http://10.0.129.9/RDWeb/Pages/zh-CN/password.aspx', tag: 'MFG域修改密码'},
...
//自定义列表
var viplist=[
     {value: "hrefLink", hrefLink: "http://shareedit/_layouts/15/WopiFrame.aspx?sourcedoc={E29CD54E-AEB2-4537-A57D-934CB83A8561}&file=hrefLink.xlsx&action=default"},
     {value: "html", hrefLink: "https://www.jq22.com/webide/"},
...
for(i = 0; i < obj.length; i++){
    ...
    var textnode=document.createTextNode(obj[i].tag);
...
function search(){
    ...
    for(i = 0; i < viplist.length; i++){
        if(
            searchTxt.value == viplist[i].value
           ){
            window.open(viplist[i].hrefLink,"_blank").location;
        }
     }
